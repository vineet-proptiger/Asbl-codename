...
const Footer = () => (
  <footer style={{ background: 'var(--color-dark)', color: '#fff', textAlign: 'center' }}>
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '60px 24px 40px' }}>
      ...
      <p style={{ fontSize: '14.5px', color: '#ccc', fontFamily: F_SANS, lineHeight: 1.8, marginBottom: '24px', maxWidth: '900px', margin: '0 auto 24px' }}
      ...
      {/* RERA Section */}
      <div style={{ borderTop: '1px solid #222', padding: '12px 0', marginBottom: '8px' }}>
        <p style={{ fontSize: '14px', color: '#ccc', fontFamily: F_SANS, fontWeight: '600' }} data-aos="fade-in">
