...
const highlights = [
  { title: 'PREMIUM TOWERS', desc: 'Premium high-rise towers in Central Hyderabad', Icon: IconHome },
  { title: 'PRIME LOCATION', desc: 'Prime location at Nallakunta near RTC X Roads', Icon: IconRoad },
  { title: 'LIFESTYLE AMENITIES', desc: 'World-class lifestyle & clubhouse amenities', Icon: IconStar },
  { title: 'CONNECTIVITY', desc: 'Excellent connectivity to key city hubs', Icon: IconSmart },
  { title: 'GATED COMMUNITY', desc: 'Modern gated community for urban living', Icon: IconGate },
  { title: 'ELEGANT DESIGN', desc: 'Premium construction with elegant design', Icon: IconKey },
  { title: 'LUXURY APARTMENTS', desc: 'Offering premium 3 & 4 BHK luxury apartments designed for modern urban living.', Icon: IconRupee },
  { title: 'THOUGHTFUL PLANNING', desc: 'Over 2,00,000 sq ft of curated spaces for sports, wellness, and community living.', Icon: IconTrees },
]
