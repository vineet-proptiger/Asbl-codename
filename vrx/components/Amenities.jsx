...
const newAmenities = [
  { icon: Waves,          title: 'SWIMMING POOL',             desc: 'A well-maintained swimming pool to support your fitness and relaxation goals.' },
  { icon: Trophy,         title: 'GYMNASIUM',                 desc: 'Fully equipped modern gymnasium for an active and healthy lifestyle.' },
  { icon: Flower2,        title: 'NATURE THEMED GARDEN',      desc: 'Beautifully landscaped nature-themed gardens for fresh air and wellness.' },
  { icon: PersonStanding, title: 'JOGGING TRACK',             desc: 'Dedicated jogging track through green spaces for a healthy and active lifestyle.' },
  { icon: Gamepad2,       title: 'KIDS PLAY AREA',            desc: 'Safe and vibrant kids play area designed for fun, exploration, and active engagement.' },
  { icon: Building2,      title: 'MULTIPURPOSE HALL',         desc: 'A grand multipurpose hall for community events, celebrations, and social gatherings.' },
  { icon: Coffee,         title: 'PREMIUM LIFESTYLE AMENITIES', desc: 'World-class lifestyle and wellness amenities for an elevated living experience.' },
  { icon: ShieldCheck,    title: '24×7 GATED SECURITY',       desc: '24×7 gated security and surveillance ensuring complete safety and peace of mind.' },
]
