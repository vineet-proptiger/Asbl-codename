...
export default function LuxuryApartments() {
  const [isOpen, setIsOpen] = useState(false)

  const customHeroImages = [
    '/luxury-apartments-in-hyderabad/hero/banner1.webp',
    '/luxury-apartments-in-hyderabad/hero/banner2.webp'
  ];
  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      {/* Yahan par customImages prop send kar rahe hain */}
      <Hero setIsOpen={setIsOpen} customImages={customHeroImages} />
